...
from model_utils import KNOWN_CATEGORICAL_COLS, RAW_INPUT_COLS, get_unit_breakdown, load_model_bundle, predict_retention_time
    ...
    for section, fields in SECTIONS.items():
        with st.container():
            ...
            for idx, col_name in enumerate(fields):
                with cols[idx % 2]:
                    if col_name in bundle.get("input_categorical_cols", []) or col_name in KNOWN_CATEGORICAL_COLS:
